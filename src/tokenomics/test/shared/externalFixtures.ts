...
} from '@cryptoalgebra/v1.9-directional-fee-core/artifacts/contracts/AlgebraFactory.sol/AlgebraFactory.json'
import {
  abi as POOL_DEPLOYER_ABI,
  bytecode as POOL_DEPLOYER_BYTECODE,
} from '@cryptoalgebra/v1.9-directional-fee-core/artifacts/contracts/AlgebraPoolDeployer.sol/AlgebraPoolDeployer.json'
