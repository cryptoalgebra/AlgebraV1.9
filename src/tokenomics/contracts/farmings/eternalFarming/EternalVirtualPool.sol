...
import '@cryptoalgebra/v1.9-ve-core/contracts/libraries/TickManager.sol';

import '@cryptoalgebra/v1.9-ve-core/contracts/libraries/FullMath.sol';
import '@cryptoalgebra/v1.9-ve-core/contracts/libraries/Constants.sol';
import '@cryptoalgebra/v1.9-ve-core/contracts/libraries/LowGasSafeMath.sol';
...
contract EternalVirtualPool is AlgebraVirtualPoolBase, IAlgebraEternalVirtualPool {
    ...
    function rewardReserves() external view override returns (uint256 reserve0, uint256 reserve1) {
